...
export const ui = {
  en: {
    ...
    "nav.login": "Login",
    "nav.signup": "Sign Up",
    "hero.title": "Lessons and insights",
    "hero.subtitle": "from 8 years",
    "hero.description":
      "  Where to grow your business as a photographer: site or social media?",
    "hero.button": "Register",
    "clients.title": "Our clients",
    "clients.subtitle": "We have been working with some Fortune 500+ clients",
    "community.intro": "Manage your entire community <br /> in a single system",
    "community.title": "Who is Nextcent suitable for?",
    ...
    "achievements.label3": "Event Bookings",
    ...
    "updates.title": "Caring is the new marketing",
    "updates.description":
    ...
    "updates.card1": "Creating Streamlined Safeguarding Processes with OneRen",
    "updates.card2":
    ...
    "footer.linksTitle1": "Company",
    "footer.link1": "About Us",
    "footer.link2": "Blog",
    "footer.link3": "Contact us",
    "footer.link4": "Pricing",
    "footer.link5": "Testimonials",
    "footer.linksTitle2": "Support",
    "footer.link6": "Help Center",
    "footer.link7": "Terms of Service",
    "footer.link8": "Legal",
    "footer.link9": "Privacy Policy",
    "footer.link10": "Status",
    "footer.subscribe": "Stay up to date",
  ...
  es: {
    ...
    "updates.card1":
      "Creación de procesos de protección simplificados con OneRen",
    "updates.card2":
      "¿Cuáles son tus responsabilidades de protección y cómo puedes gestionarlas?",
    "updates.card3":
    ...
    "footer.linksTitle1": "Empresa",
    "footer.link1": "Sobre nosotros",
    "footer.link2": "Blog",
    "footer.link3": "Contáctenos",
    "footer.link4": "Precios",
    "footer.link5": "Testimonios",
    "footer.linksTitle2": "Soporte",
    "footer.link6": "Centro de ayuda",
    "footer.link7": "Términos de servicio",
    "footer.link8": "Legal",
